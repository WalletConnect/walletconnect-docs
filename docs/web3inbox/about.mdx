...
- Finally, use our [API in your backend](backend-integration) to send notifications to subscribed users.
...
Web3Inbox supports EOA accounts on all chains, and smart accounts on all `eip155` chains that our Blockchain API [supports](https://github.com/WalletConnect/blockchain-api/blob/master/SUPPORTED_CHAINS.md). We have plans to expand support in the future.
