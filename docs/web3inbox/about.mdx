  ...
  items={[
    {
      ...
      description: 'Drop-in widget for fast Web3Inbox integration with limited customization',
      icon: w3wLogo,
      href: '/2.0/web3inbox/embedded-widget/about'
    },
    {
...
- [Embedded widget](embedded-widget/about): Drop-in widget for fast integration. Limited customization.
