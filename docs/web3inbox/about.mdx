  ...
  items={[
    {
      ...
      icon: w3iLogo,
      href: './frontend-integration/about'
    }
  ]}
/>
...
- In your app's frontend using our [frontend SDK](frontend-integration/about)
...
- Optionally, allow users to subscribe to notifications in your app frontend with our [frontend SDK](frontend-integration/about).
