...
- In your app's UI using [Core Components](core-components/about)
...
- Allow users to subscribe and few notifications in your app with [core components](core-components/about).
- Finally, [send notifications](sending-notifications) from your backend.
