...
This SDK utilizes WalletConnect's Notify API and is designed for Web3 scenarios, providing event-based notifications for activities like DAO votes, DeFi transaction alerts, and updates for NFT holders. Apps can send notifications to subscribed accounts, and users can receive and view their notifications in a supporting wallet, in the [Web3Inbox.com app](https://app.web3inbox.com?_vercel_share=EkWCdc3K4KykuhNepPnW52LcuwPj6md4), or in the app's frontend. Users can also discover Notify-compatible apps in their wallet or the [Web3Inbox.com app](https://app.web3inbox.com?_vercel_share=EkWCdc3K4KykuhNepPnW52LcuwPj6md4) to subscribe to.

The Web3Inbox SDK is not to be confused with the [Web3Inbox.com app](https://app.web3inbox.com?_vercel_share=EkWCdc3K4KykuhNepPnW52LcuwPj6md4) which allows users to receive and manage their notifications from all apps, as they would in a wallet.
...
- **Device push notifications:** Push notifications to the user's wallet (if it supports Notify API) or the [Web3Inbox.com app](https://app.web3inbox.com?_vercel_share=EkWCdc3K4KykuhNepPnW52LcuwPj6md4).
...
- In the [Web3Inbox.com app](https://app.web3inbox.com?_vercel_share=EkWCdc3K4KykuhNepPnW52LcuwPj6md4) which supports push notifications and can be installed to the user's phone
...
Users can subscribe to notifications in your frontend, and if you are a featured app then users can subscribe in the [Web3Inbox.com App](https://app.web3inbox.com?_vercel_share=EkWCdc3K4KykuhNepPnW52LcuwPj6md4) or a supporting wallet.
