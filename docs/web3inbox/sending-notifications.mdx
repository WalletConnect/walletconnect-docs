...
We recommend testing notifications with the [Web3Inbox.com app](https://app.web3inbox.com?_vercel_share=EkWCdc3K4KykuhNepPnW52LcuwPj6md4) which supports push notifications and can be installed to your phone. You can also try one of our sample wallets:
