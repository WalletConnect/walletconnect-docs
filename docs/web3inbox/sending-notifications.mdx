...
Once an account is subscribed to your app's notifications you can test sending notifications to the account. User can subscribe in your app directly with our [Frontend Integration](frontend-integration/usage), or with one of the below testing options.
...
- `type` - the Notification type ID which you can copy from WalletConnect Cloud
