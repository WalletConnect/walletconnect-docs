...
A list is maintained by WalletConnect to dapps one can subscribe to.

You can add your app to this list by following: https://docs.walletconnect.com/web3inbox/cloud-setup
