...
Most apps that wants to send you notifications using Web3Inbox ~~WalletConnect Notify API~~ will request you to sign this message. This will allow the app to simply interact with you directly via notifications, and if you wish to opt-in to receiving notifications it is safe to sign this message.
