...
```ts
const { account, setAccount } = useAccount(onSignFunction)
```

- account -> CAIP-10 account currently active in Web3Inbox
- setAccount -> Change actively managed account in Web3Inbox
- onSignFunction -> Async function used to sign a message (for registering) of type:
...
- account -> CAIP-10 account currently active in Web3Inbox
- setAccount -> Change actively managed account in Web3Inbox
- onSign-> Function used to sign a message, of type: 
...
- subscription: Reactive state, returning current subscription informatio, of type:
...
- account -> CAIP-10 account currently active in Web3Inbox
- subscription: *Non-Reactive* state, returning current subscription informatio, of type:
