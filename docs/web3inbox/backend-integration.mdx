...
You can tell if an account is subscribed and get information about subscribers using the `/get-subscribers` endpoint. You can provide up to 100 accounts in the request.
