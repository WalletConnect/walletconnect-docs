...
This method signs and submits a transaction with the provided instuctions.
...
### Returns
    ...
    1. `Object`
    	1.1. `signature` : `String` - corresponding signature for submitted transaction
...
// Result
{
	"id": 1,
	"jsonrpc": "2.0",
	"result":  { signature: "ZLmZjrHBcDisSSJEGj7N7LvhyqqjFhv5pzS1Q2hCShVZCYN2u9jFqhGT3swFJ3wK4fVGfQmYDR3v6yUSyfhNG4w" }
}
```
