...
6. Wallet sends push subcribe request (type 1 envelope) on response topic with subscriptionAuth
7. Cast Server receives push subscribe request on subscribe request
...
12. Wallet subscribes to Push Topic
