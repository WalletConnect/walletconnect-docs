...
To check more in details go and visit our [Web3Wallet Web implementation app](https://github.com/WalletConnect/web-examples/tree/main/wallets/react-web3wallet)
