...
The wallet can then approve the proposal using either of the following:
...
<PlatformTabs groupId="w3w" activeOptions={["web","ios","android","flutter","react-native","unity"]}>
<PlatformTabItem value="web">
...
Auth requests are only supported on iOS, Android & Flutter
