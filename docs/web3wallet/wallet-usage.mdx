...
It focuses solely on collecting data about code execution and error codes, without tracking any sensitive user information.
...
These stored events are then transmitted to the server using the Pulse API whenever the SDK is initialized.
