...
To respond to the request, you can access the `topic` and `request` object by destructuring them from the event payload. To see a list of possible `request` and `response` objects, refer to the relevant JSON-RPC Methods for [Ethereum](../cloud/chains/rpc-reference/ethereum-rpc.md), [Solana](../cloud/chains/rpc-reference/solana-rpc.md), [Cosmos](../cloud/chains/rpc-reference/cosmos-rpc.md), or [Stellar](../cloud/chains/rpc-reference/stellar-rpc.md).
