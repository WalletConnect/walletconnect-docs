...
You can use [Web3Modal Labs](https://lab.web3modal.com/) to test and verify that your wallet supports One-click Auth properly.

<Button name="Test One-click Auth" url="https://lab.web3modal.com/" />
