...
We are also working on some more advanced spam mitigation strategies including publisher scoring based on huristics such as open rate and manually reported spam complaints.
