...
For React Native wallets, there are ready made utilities available in both vanilla JS and also ready made React hooks.
...
Before begin using Web3Inbox, you will first need to [setup your project](../../../web3inbox/cloud-setup) to send notifications.
...
- Make use of [notification types](../../../web3inbox/cloud-setup#notification-types). These allow the user fine-grained control over what types of notifications they want to receive from your app. These allow users to only unsubscribe from the specific notifications they are no longer interested in, rather than needing to unsubscribe from your entire app. Your app should include functionality to manage notification preferences.
