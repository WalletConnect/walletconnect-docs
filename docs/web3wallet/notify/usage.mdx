...
[Configure Project](/docs/advanced/push-server.md)
...
To enable push notifications, first you'll need to [configure your project](/docs/advanced/push-server.md) with Firebase Messaging service.
