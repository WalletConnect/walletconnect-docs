...
Inside your notification service extension file, import WalletConnectNotify, initialize `Web3WalletDecryptionService()` for Web3Wallet or NotifyDecryptionService for Notify , and decrypt the message with the following Swift code:

:::caution
See full [UNNotificationServiceExtension](https://developer.apple.com/documentation/usernotifications/unnotificationserviceextension) implementation in our [SampleApp](https://github.com/WalletConnect/WalletConnectSwiftV2/blob/main/Example/PNDecryptionService/NotificationService.swift)
:::
