...
:::caution
Update me after new specs change of the new registration flow. Szymon will update me.
:::
...
:::caution
I need to implement it in the client first. Will update afterwards. Szymon will update me.
:::
</PlatformTabItem>
...
:::caution
Needs update after w3w push notification page is changed. Szymon will update me.
:::

### NotifyClient.Delegate

:::caution 
Update after delegate change. Szymon will update me.
:::
