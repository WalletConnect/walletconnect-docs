...
This feature is only available for iOS versions lower than 17.

For iOS 17.0 and higher, it's recommended for wallets to present a toast/alert message instructing the user to manually switch back to a dapp.
