...
import MobileWalletsPartial from '../web/web3modal/_partials/options/mobileWallets.mdx'
import DesktopWalletsPartial from '../web/web3modal/_partials/options/desktopWallets.mdx'
import WalletImagesPartial from '../web/web3modal/_partials/options/walletImages.mdx'
import ExplorerRecommendedWalletIdsPartial from '../web/web3modal/_partials/options/explorerRecommendedWalletIds.mdx'
import ExplorerExcludedWalletIdsPartial from '../web/web3modal/_partials/options/explorerExcludedWalletIds.mdx'
import TermsOfServiceUrlPartial from '../web/web3modal/_partials/options/termsOfServiceUrl.mdx'
import PrivacyPolicyUrlPartial from '../web/web3modal/_partials/options/privacyPolicyUrl.mdx'
import EnableExplorerPartial from '../web/web3modal/_partials/options/enableExplorer.mdx'
import ThemeModePartial from '../web/web3modal/_partials/options/themeMode.mdx'
import ThemeVariablesPartial from '../web/web3modal/_partials/options/themeVariables.mdx'
import ProjectIdPartial from '../web/web3modal/_partials/options/projectId.mdx'
import EnableAuthModePartial from '../web/web3modal/_partials/options/enableAuthMode.mdx'
import ChainsPartial from '../web/web3modal/_partials/options/chains.mdx'
