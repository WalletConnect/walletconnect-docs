...
Indicates the daily average of sessions created when the user signs a message with their connected wallet.
...
Total number of sessions created when the user signs a message with their connected wallet.
...
<Table
  ...
  data={[
    [
      'Session',
      'A session represents the connection established between your project and your user’s device (includes browsers).'
    ],
    [
      'Message',
