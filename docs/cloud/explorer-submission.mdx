...
<Table
  ...
  data={[
    ...
    },
    {
      ...
      steps: `1. Open the WalletConnect connection page https://evmtest.walletconnect.com or https://react-app.walletconnect.com/ from a PC
    ...
    },
    {
      ...
      steps: `1. Once the wallet is connected press on the modal button on the top right of the website.
              ...
              3. Select any available chain, close the modal and press the “Send Transaction” button on the eth_sendTransaction card.`,
  ...
  data={[
    {
      ...
      steps: `1. Open https://evmtest.walletconnect.com in your mobile device.
              2. Fill in the wallet’s name and it’s deeplink (Mobile Link) in the “Add a Custom Wallet to Web3Modal” form. Press the “Apply”. After the website reloads press the “Connect Wallet” button and select the new created wallet.
    ...
    },
    {
      ...
      steps: `1. Once the wallet is connected a card with the personal_sign label will show up
              2. Press the “Sign Message” button on the card.
    ...
    },
    {
      ...
      steps: `1. Once the wallet is connected a card with the signTypedData_v4 label will show up
              2. Press the “Sign Typed Data” button on the card.
              3. Accept the signature request on the wallet.`,
      expectedResults: `1. N/A
                        2. A modal should popup on the wallet app requesting for a signature.
                        3. Once accepted and signed the hash should show up on the website.`
    },
    {
      ...
      steps: `1. Once the wallet is connected a card with the eth_sendTransaction label will show up
              2. Press the “Send Transaction” button on the card.`,
      expectedResults: `1. N/A
                        2. A modal should popup on the wallet app requesting for a signature.`
    },
  ]}
