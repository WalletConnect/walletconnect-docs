...
However, doing so ensures that your project is listed under [WalletConnect Explorer](https://walletconnect.com/explorer?utm_source=walletconnect-docs&utm_medium=cloud&utm_campaign=explorer-submission) and [Cloud Explorer API](./explorer.md#cloud-explorer-api).
