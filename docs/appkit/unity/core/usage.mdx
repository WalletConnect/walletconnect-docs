...
**AppKit for Unity** is currently in **Alpha**. Breaking changes may occur in future versions.
...
AppKit comes with the [Nethereum](https://nethereum.com/) integration out of the box.
