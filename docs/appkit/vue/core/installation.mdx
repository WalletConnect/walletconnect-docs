...
AppKit has support for [Wagmi](https://wagmi.sh/) and [Ethers](https://docs.ethers.org/v6/), which will help you interact with wallets and smart contracts.
...
AppKit Solana is in Beta and is not recommended for production use.
:::
```bash npm2yarn
