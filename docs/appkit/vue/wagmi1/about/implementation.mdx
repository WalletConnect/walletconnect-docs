...
Default mode will implement WalletConnect, Browser Wallets (injected) and Coinbase options in addition to [Wagmi's public provider](https://1.x.wagmi.sh/core/providers/public) and [WalletConnect's provider](../../../../cloud/blockchain-api.mdx).
