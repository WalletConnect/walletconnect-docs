...
AppKit provides a toolkit for integrating Web3 notification features into apps. Web3Inbox can be used to send notifications from your app directly to wallets.
