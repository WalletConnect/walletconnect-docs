---
pagination_next: appkit/features/email
title: Overview
---
...
import SolanaBanner from '../components/SolanaBanner.js'
...
The AppKit SDK allows you to easily connect your Web3 app with wallets. It provides a simple and
