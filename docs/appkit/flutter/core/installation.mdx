...
If you don't feel to override the dependency you can disable Coinbase Wallet support as explained in the [Disable Coinbase Wallet](#disable-coinbase-wallet) section.
