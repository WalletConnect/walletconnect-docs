...
### Account Activation Sponsorship

WalletConnect Appkit will sponsor accounts deployments for the following networks reducing your activation cost to 0! Account Deployment Sponsorship is currently available on:
