...
Appkit with ethers v5 don't support the `auth` parameter and social logins. If you're using ethers v5, please consider upgrading to ethers v6 following this [ethers migration guide](https://docs.ethers.org/v6/migrating/) and [Appkit Docs](https://docs.walletconnect.com/appkit/overview)
:::
</PlatformTabItem>
</PlatformTabs>
