...
+ Replace the wagmi config for this example. Also you can customize the `auth` object with the socials you want to enable following the [guidelines](https://docs.walletconnect.com/appkit/react/core/custom-connectors?platform=wagmi).
