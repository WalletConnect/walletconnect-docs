...
const DetailedFeedback = ({ feedback, reset, path }) => {
  ...
  return (
    <div className="feedback__detailed">
      {feedback === 1 || submitted ? (
        <>
          <p className="feedback__detailed__text feedback__detailed__text--positive">
        ...
        <>
          <p className="feedback__detailed__text">What went wrong?</p>
          {otherClicked ? (
            <div className="feedback__detailed__other">
              <textarea
            ...
            <>
              <div className="feedback__detailed__options">
                <button
                  className="feedback__detailed__option"
                ...
                <button
                  ...
                  className="feedback__detailed__option feedback__detailed__option--other"
                >
                  Something Else
                </button>
              </div>
  ...
  return (
    <div className="feedback">
      {feedback ? (
        ...
        <>
          <p className="feedback__text">Was this helpful?</p>
          <div className="feedback__options">
            <button
              onClick={() => handleClick(1)}
              className="feedback__option feedback__option--yes"
            >
              Yes
              <svg
            ...
            <button
              onClick={() => handleClick(-1)}
              className="feedback__option feedback__option--no"
            >
              No
              <svg
                xmlns="http://www.w3.org/2000/svg"
