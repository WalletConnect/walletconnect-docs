...
:::info
For additional type packages refer to our [TypeScript Guide](../old/javascript/guides/typescript).

For platform-specific instructions, refer to our [React Native](../old/javasscript/guides/react-native) and [Node.js](../guides/nodejs.md) guides.
:::
