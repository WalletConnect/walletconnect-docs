...
Set or override the images for any [Wagmi connector](https://wagmi.sh/core/connectors/injected). The key of each property must match the id of the connector.
