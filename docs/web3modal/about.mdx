...
:::info Note
Looking to upgrade from Web3Modal v2? Check out the [upgrade guide](./upgrade.mdx).
:::
...
- **OnRamp.** Enable users to buy crypto with fiat
- **Email Login.** Allow users to seamlessly connect to dapps with their email address.
