...
<Wrapper
  ...
  items={[
    {
      name: 'React + ethers',
      description: 'Get started with Web3Modal and ethers in React.',
      icon: reactLogo,
      href: '/2.0/web3modal/platforms/react?provider=ethers'
    },
    {
      name: 'React + viem',
      description: 'Get started with Web3Modal and viem in React.',
      icon: reactLogo,
      href: '/2.0/web3modal/platforms/react?provider=viem'
    },
    {
      name: 'HTML + ethers',
      description: 'Get started with Web3Modal and ethers in HTML.',
      icon: htmlLogo,
      href: '/2.0/web3modal/platforms/html?provider=ethers'
    }
  ]}
/>
