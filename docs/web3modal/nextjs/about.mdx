...
- You may need to update Web3Modal related import statements like so:

```ts
// import next.js lazy loading composite
...
// to:
const Web3Modal = dynamic(() => import('../context/web3modal'), {
    ssr: false,
})
```
