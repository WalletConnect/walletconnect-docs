...
:::caution
Email Login is currently in alpha and only supported in Wagmi & Ethers v6. Email is only for testing and not recommended for production apps.
:::
...
Read more about Wagmi hooks for smart contract interaction [here](https://wagmi.sh/react/hooks/useContractRead).
