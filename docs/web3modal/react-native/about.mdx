...
<div>
Follow these steps to install Coinbase SDK in your project along with out custom wagmi connector.

Check <a href="https://coinbase.github.io/wallet-mobile-sdk/docs/client-sdk/rn-install">Coinbase official docs</a> for more detailed information.
...
3. Install our custom wagmi connector `yarn add @web3modal/coinbase-react-native`
...
6. Add SDK responses listener in your project following <a href="https://coinbase.github.io/wallet-mobile-sdk/docs/client-sdk/rn-setup#listening-for-responses">Coinbase Docs</a>
```tsx
...
7. Initialize Coinbase Connector and add it in `extraConnectors`
