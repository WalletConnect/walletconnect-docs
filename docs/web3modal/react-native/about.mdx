...
:::caution
**The Web3Modal SDK is currently in Beta and is not production-ready**.

However, it is stable and its public API and associated documentation will not undergo significant changes.
:::
