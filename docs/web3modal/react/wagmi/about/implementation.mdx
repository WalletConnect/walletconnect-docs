...
1. **WalletConnectConnector**: Enables cross-device wallet connections using the [WalletConnect](https://walletconnect.com/) provider, adhering to [EIP-1193](https://eips.ethereum.org/EIPS/eip-1193).
...
Additionally, there's a `publicProvider` for reading blockchain data through public nodes like Infura. The `WagmiConfig` component shares `wagmiConfig` with child components.
:::
