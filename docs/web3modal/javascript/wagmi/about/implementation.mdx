...
```ts
import { createWeb3Modal, walletConnectProvider, EIP6963Connector, EmailConnector } from '@web3modal/wagmi'
...
:::note
The provided code utilizes [Wagmi](https://wagmi.sh/), a JavaScript library for wallet and provider connections, along with the [Web3Modal](https://web3modal.com/) library to create a wallet connection modal. It features various connectors:
