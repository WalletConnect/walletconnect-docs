...
To open Web3Modal you can use our [**web component**](http://localhost:3000/web3modal/javascript/components) or build your own button with Web3Modal [**actions**](http://localhost:3000/web3modal/javascript/actions#open-and-close-the-modal).
