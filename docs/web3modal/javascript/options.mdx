...
const solanaMainnet = {
  ...
  rpcUrl: `https://rpc.walletconnect.com/v1?chainId=solana:4sGjMW1sUnHzSxGspuhpqLDx6wiyjNtZ&projectId=${projectId}` // Get projectId from https://cloud.walletconnect.com
}
