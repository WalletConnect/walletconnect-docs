...
```bash npm2yarn
npm install @web3modal/wagmi@alpha @wagmi/core @wagmi/connectors viem
```
...
```bash npm2yarn
npm install @web3modal/ethers5@alpha ethers@5.7.2
```
...
```bash npm2yarn
npm install @web3modal/ethers@alpha ethers
```
