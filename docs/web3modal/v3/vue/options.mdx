  ...
  customWallets:[
    {
      ...
      image_url: "wallet_image",  //optional
      order: 2,  //optional
...
You can select the wallets that are going to be shown on the modal's main view. Default wallets are MetaMask and Trust Wallet. 
You can find the wallets ids in the [WalletConnect Explorer](https://walletconnect.com/explorer?type=wallet)
...
List of optional properties for `<w3m-button />`
...
List of optional properties for `<w3m-account-button />`
...
List of optional properties for `<w3m-connect-button />`
...
List of optional properties for `<w3m-network-button />`
