...
```bash npm2yarn
npm install @web3modal/wagmi@3.0.0-alpha.3 @wagmi/core viem
```
...
Default mode will implement WalletConnect, Extension Wallets (injected) and Coinbase options in addition to Wagmi's public clients and WalletConnect's provider.
