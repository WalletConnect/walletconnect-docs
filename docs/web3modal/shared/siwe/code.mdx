...
:::note
The nonce and verification process will be implemented in our backend. [Read more.](https://docs.login.xyz/sign-in-with-ethereum/quickstart-guide/implement-the-backend)
:::
