...
To open Web3Modal you can use our [**web component**](../../components.mdx) or build your own button with the Web3Modal [**composables**](../../composables.mdx#open-and-close-the-modal).
