...
Check out [pub.dev](https://pub.dev/packages/web3modal_flutter/versions) for the version you would like to install and add it as dependency in your pubspec.yaml (and run an implicit `flutter pub get` ):

```ruby
dependencies:
  web3modal_flutter: ^3.0.0-beta01
```
