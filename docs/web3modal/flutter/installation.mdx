...
Check on [pu.dev](https://pub.dev/packages/web3modal_flutter/versions) the version you would like to install and add it as dependency in your pubspec.yaml (and run an implicit flutter pub get):
