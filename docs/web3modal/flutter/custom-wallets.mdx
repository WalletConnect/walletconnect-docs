...
These values are optionals and, in most cases, not required since Web3Modal already defines every required and optional namespace internally. However, if you would want to override that definition with yout own, these are the object yout should use.
