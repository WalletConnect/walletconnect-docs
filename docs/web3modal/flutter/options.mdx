...
The service's metada object contains a `redirect` option that serves to the purpose of redirecting back to your dapp from the connected wallet. Please see [mobileLinking](../../web3wallet/mobileLinking) docs for a bit more of context.
