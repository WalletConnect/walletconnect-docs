...
### Web3Modal SDK
This one is simple. Update wagmi to its latest version; the version must be [version here] or higher.
...
Same as for the Web3Modal SDK. Update wagmi to its latest version; the version must be [version here] or higher. 
