...
You can define session properites by calling the `setSessionProperties` method on the `Web3Modal` object.
...
<PlatformTabItem value="kotlin-dsl">
...
<PlatformTabItem value="nav-graph">
