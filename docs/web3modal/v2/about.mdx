...
:::info
This documentation is for Web3Modal v2. You can find Web3Modal v3 in its Alpha version [here](../about.mdx)
:::
  ...
  items={[
    {
      ...
      icon: reactLogo,
      href: '/2.0/web3modal/v2/react/wagmi/installation'
    },
    {
      name: 'HTML + wagmi',
      description: 'Get started with Web3Modal and wagmi in HTML.',
      icon: htmlLogo,
      href: '/2.0/web3modal/v2/html/wagmi/installation'
    }
  ]}
/>
