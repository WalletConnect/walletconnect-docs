...
For a majority of use cases you simply need to swap npm imports to cdn ones, however due to some downstream package issues with cdn workflows, we recomend using pre-packaged version of wagmi core as shown below. (`WagmiCore` imports).
