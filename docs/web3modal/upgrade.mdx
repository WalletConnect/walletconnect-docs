...
:::note
Make sure to set your configuration outside the App component to avoid unwanted rerenders. Or use `useMemo`/`useEffect` hooks to generate configuration and create Web3Modal only once.
:::
