...
This is an opinionated quickstart guide for Web3Modal using Next.js. <br/>
If you are looking for a more in-depth guide for other frameworks like Vue, Vanilla JS or platforms like Android, Flutter, please refer to [Web3Modal Docs](./web3modal/about).
...
We are using [create-wc-dapp](https://github.com/WalletConnect/create-wc-dapp/tree), the official quickstart CLI for Web3Modal from WalletConnect
