# Polkadot Wallet Connect -- dApp Integration Guide
...
5. Create a standalone modal using your dapps wallet connect projectid and specifying version 2 of wallet connect.
```
