tabimport Container from '.tab./../components/Container'
import Tabs from '@theme/Tabs'
import TabItem from '@theme/TabItem'
import PlatformTabs from '.esc./../components/PlatformTabs'
import PlatformTabItem from '.tab./../components/PlatformTabItem'
