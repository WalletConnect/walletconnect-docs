...
:::caution
**The WalletConnectModal SDK is currently in Beta and is not production-ready**.

It's public API, prefab structure, and associated documentation may still see significant and breaking changes.
:::
