...
Since this is a canary release, we **DO NOT** recommend using it in production. However, you should test it out in your staging environment to ensure you can migrate smoothly once the official release is out.
