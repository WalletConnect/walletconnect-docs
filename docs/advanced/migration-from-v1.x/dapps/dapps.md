...
```bash npm2yarn
npm install connectkit@^latest wagmi@^latest
```
...
- [Ethers.js Adapters](https://wagmi.sh/react/ethers-adapters) for wagmi
...
```bash npm2yarn
npm install @rainbow-me/rainbowkit@^1.0.2 wagmi@^1.2
```
