...
The Push Server is a push server for the WalletConnect v2 Protocol. It allows clients to send push notifications to their users. The Push Server can be used alongside our [Push API](../api/notify/usage.mdx) and [Web3Wallet SDK](../web3wallet/about.mdx).
