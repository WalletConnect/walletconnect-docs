...
- If `rpcMap` is not defined it will fallback into the [Blockchain API](../../cloud/blockchain-api.md) RPCs. Keep in mind that the Blockchain API supports a limited [list of chains](https://github.com/WalletConnect/rpc-proxy/blob/master/SUPPORTED_CHAINS.md).
:::
...
When `showQrModal` is enabled, ethereum provider will automatically show and hide [WalletConnectModal](../walletconnectmodal/about.mdx).
