...
WalletConnectModal is a simple ui library intended for advanced use cases where users manage other wallet connect api's themselves. You are expected to generate connection uri's and pass them to the modal yourself.
