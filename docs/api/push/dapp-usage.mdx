...
This means that the `PushDappClient` should be used alongside the [Sign SDK](../sign/about.mdx) or the
[Auth SDK](../auth/about.mdx), via the [Shared Core](../core/shared-core.md) setup.
:::
