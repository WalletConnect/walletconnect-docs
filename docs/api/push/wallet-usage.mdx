...
This means that the `PushWalletClient` should be used alongside the [Web3Wallet SDK](../../web3wallet/about.mdx), via the [Shared Core](todo) setup.
:::
...
To read more about User Action Push Notifications, go [here](todo).
