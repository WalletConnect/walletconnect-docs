  ...
  themeConfig:
    /** @type {import('@docusaurus/preset-classic').ThemeConfig} */
    {
      ...
      announcementBar: {
        id: 'support_us',
        content:
          '🚨 v1.0 has been sunset. Wallets and apps must upgrade to v2.0 by February 28. <a rel="noopener noreferrer" href="/2.0/advanced/migrating-from-v1.0">Learn more</a>. 🚨',
