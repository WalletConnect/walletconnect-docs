...
const config = {
  ...
  themeConfig: {
    ...
    announcementBar: {
      id: 'support_us',
      content:
        'It’s shipping szn 🚢 Explore Web3Modal’s latest features: Email Wallets and On-ramp! <a rel="noopener noreferrer" href="/web3modal/about#features">Read the docs</a>',
